...
export const showProducts = (productMap, control) => {
    ...
    if (!control) {
        ...
        $('.product__checkbox-label').on('click', function (e) {
            ...
            if($('.product__category .product__category-item input[type=checkbox]:checked').length === 0) {
                $(this).parents('.product').find('.product__list-category').removeClass('product__list-category--active');
            }
